...
==================================================================================================*/
#define CDD_I2C_CFG_VENDOR_ID_C                     43
#define CDD_I2C_CFG_AR_RELEASE_MAJOR_VERSION_C      4
#define CDD_I2C_CFG_AR_RELEASE_MINOR_VERSION_C      7
#define CDD_I2C_CFG_AR_RELEASE_REVISION_VERSION_C   0
#define CDD_I2C_CFG_SW_MAJOR_VERSION_C              3
#define CDD_I2C_CFG_SW_MINOR_VERSION_C              0
#define CDD_I2C_CFG_SW_PATCH_VERSION_C              0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_I2c_Cfg.h header file are of the same vendor */
#if (CDD_I2C_CFG_VENDOR_ID_C != CDD_I2C_VENDOR_ID_CFG)
...
#if ((CDD_I2C_CFG_AR_RELEASE_MAJOR_VERSION_C    != CDD_I2C_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (CDD_I2C_CFG_AR_RELEASE_MINOR_VERSION_C    != CDD_I2C_AR_RELEASE_MINOR_VERSION_CFG) || \
     (CDD_I2C_CFG_AR_RELEASE_REVISION_VERSION_C != CDD_I2C_AR_RELEASE_REVISION_VERSION_CFG))
...
#if ((CDD_I2C_CFG_SW_MAJOR_VERSION_C != CDD_I2C_SW_MAJOR_VERSION_CFG) || \
     (CDD_I2C_CFG_SW_MINOR_VERSION_C != CDD_I2C_SW_MINOR_VERSION_CFG) || \
     (CDD_I2C_CFG_SW_PATCH_VERSION_C != CDD_I2C_SW_PATCH_VERSION_CFG))
...
/* Check if current file and DEM header file are of the same version */
    ...
    #if ((CDD_I2C_CFG_AR_RELEASE_MAJOR_VERSION_C != DEM_AR_RELEASE_MAJOR_VERSION) || \
             (CDD_I2C_CFG_AR_RELEASE_MINOR_VERSION_C != DEM_AR_RELEASE_MINOR_VERSION))
