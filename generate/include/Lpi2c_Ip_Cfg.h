...
#endif
/* Check if current file and Lpi2c_Ip_PBcfg.h header file are of the same module */
#if (LPI2C_IP_CFG_MODULE_ID  != LPI2C_IP_PBCFG_MODULE_ID)
    #error "Lpi2c_Ip_Cfg.h and Lpi2c_Ip_PBcfg.h have different module IDs"
#endif
