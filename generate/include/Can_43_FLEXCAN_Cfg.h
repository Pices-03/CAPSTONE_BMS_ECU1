...
*/
#define CAN_43_FLEXCAN_MULTIPARTITION_ENABLED (STD_OFF)
...
*/
#define CAN_43_FLEXCAN_DEV_ERROR_DETECT    (STD_ON)

/**
*   @brief      Enable/Disable support Can_GetVersionInfo API
*/
#define CAN_43_FLEXCAN_VERSION_INFO_API    (STD_ON)
...
#define CAN_43_FLEXCAN_LPDU_CALLOUT_FUNC_CALLED    NULL_PTR

/**
* @brief        Enable/Disable L-PDU HRH Extend Support
*/
#define CAN_43_FLEXCAN_LPDU_HRH_EXTEND_SUPPORT    (STD_OFF)
...
#define CAN_43_FLEXCAN_MAINFUNCTION_WRITE_PERIOD    (0.001F)
/**
...
*/
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Rx_HMI_CMD    ((Can_HwHandleType)0U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_ElecMeasure    ((Can_HwHandleType)1U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_Fault    ((Can_HwHandleType)2U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_Temperature    ((Can_HwHandleType)3U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_Voltage    ((Can_HwHandleType)4U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_SOC    ((Can_HwHandleType)5U)
#define Can_43_FLEXCANConf_CanHardwareObject_HOH_Tx_Prediction    ((Can_HwHandleType)6U)
/**
