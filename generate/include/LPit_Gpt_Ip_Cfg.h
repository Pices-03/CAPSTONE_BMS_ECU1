...
#define LPIT_GPT_IP_SW_MAJOR_VERSION_CFG                3
...
/** Channels number instance LPIT_0 */
#define LPIT_0_IP_CHANNELS_NUMBER  (4U)
#define LPIT_0_IP_EXISTS
#define LPIT_0_IP_INSTANCE_NUMBER  (0U)
/*================================================================================================*/
/**
