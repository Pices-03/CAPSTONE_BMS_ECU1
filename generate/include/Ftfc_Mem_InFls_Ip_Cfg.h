...
#define FTFC_MEM_INFLS_IP_SW_MAJOR_VERSION_CFG                   3
...
/* Check if current file and Ftfc_Mem_InFls_Ip header file are of the same Software version */
    ...
    #if ((FTFC_MEM_INFLS_IP_AR_RELEASE_MAJOR_VERSION_CFG != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
         (FTFC_MEM_INFLS_IP_AR_RELEASE_MINOR_VERSION_CFG != DEVASSERT_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Ftfc_Mem_InFls_Ip_Cfg.h and Devassert.h are different"
    #endif
#endif
...
/* Development error detection for FTFC_MEM_INFLS_IP API */
#define FTFC_MEM_INFLS_IP_DEV_ERROR_DETECT                (STD_ON)
/* Pre-processor switch to enable/disable development error detection for FTFC_MEM_INFLS_IP API */
#define FTFC_MEM_INFLS_IP_DEV_ASSERT(x)                   DevAssert((x))
...
#define FTFC_MEM_INFLS_IP_ERASE_VERIFICATION              (STD_ON)

#define FTFC_MEM_INFLS_IP_PROGRAM_VERIFICATION            (STD_ON)
...
#define FTFC_MEM_INFLS_IP_ERASE_TIMEOUT                   (0U)

#define FTFC_MEM_INFLS_IP_WRITE_TIMEOUT                   (0U)

#define FTFC_MEM_INFLS_IP_ABORT_SUSPEND_TIMEOUT           (0U)

#define FTFC_MEM_INFLS_IP_ERASE_SUSPEND_TIMEOUT           (0U)

#define FTFC_MEM_INFLS_IP_ERASE_RESUME_TIMEOUT            (0U)
...
#define FTFC_MEM_INLS_IP_CODE_BLOCK_0_BASE_ADDR          (0x00000000U)
#define FTFC_MEM_INLS_IP_CODE_BLOCK_0_END_ADDR           (0x0007FFFFU)
