...
#define FTM_GPT_IP_SW_MAJOR_VERSION                3
...
/* Check if header file and Ftm_Gpt_Ip_HwAccess.h header file are of the same vendor */
#if (FTM_GPT_IP_VENDOR_ID != FTM_GPT_IP_HWACCESS_VENDOR_ID)
    #error "Vendor IDs of Ftm_Gpt_Ip.h and Ftm_Gpt_Ip_HwAccess.h are different."
#endif

/* Check if header file and Ftm_Gpt_Ip_HwAccess.h header file are of the same AUTOSAR version */
#if ((FTM_GPT_IP_AR_RELEASE_MAJOR_VERSION    != FTM_GPT_IP_HWACCESS_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_GPT_IP_AR_RELEASE_MINOR_VERSION    != FTM_GPT_IP_HWACCESS_AR_RELEASE_MINOR_VERSION) || \
     (FTM_GPT_IP_AR_RELEASE_REVISION_VERSION != FTM_GPT_IP_HWACCESS_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of Ftm_Gpt_Ip.h and Ftm_Gpt_Ip_HwAccess.h are different."
#endif

/* Check if header file and Ftm_Gpt_Ip_HwAccess.h header file are of the same software version */
#if ((FTM_GPT_IP_SW_MAJOR_VERSION != FTM_GPT_IP_HWACCESS_SW_MAJOR_VERSION) || \
     (FTM_GPT_IP_SW_MINOR_VERSION != FTM_GPT_IP_HWACCESS_SW_MINOR_VERSION) || \
     (FTM_GPT_IP_SW_PATCH_VERSION != FTM_GPT_IP_HWACCESS_SW_PATCH_VERSION))
    #error "Software version numbers of Ftm_Gpt_Ip.h and Ftm_Gpt_Ip_HwAccess.h are different."
#endif
...
extern Ftm_Gpt_Ip_ChState Ftm_Gpt_Ip_u32ChState[FTM_INSTANCE_COUNT][FTM_CONTROLS_COUNT];
...
#include "Gpt_MemMap.h"
extern uint32 Ftm_Gpt_Ip_u32NextTargetValue[FTM_INSTANCE_COUNT][FTM_CONTROLS_COUNT];
...
static inline uint32 Ftm_Gpt_Ip_GetCntValue(uint8 instance)
{
    ...
    returnCntVal = ftmGptBase[instance]->CNT;
...
{
    uint32 returnCompareVal;
    SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_16();
    returnCompareVal = ftmGptBase[instance]->CONTROLS[channel].CV;
    SchM_Exit_Gpt_GPT_EXCLUSIVE_AREA_16();
    return returnCompareVal;
}
/*================================================================================================*/
/**
