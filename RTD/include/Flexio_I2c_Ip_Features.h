...
#define FLEXIO_I2C_IP_FEATURES_SW_MAJOR_VERSION              3
...
#define FEATURE_FLEXIO_MAX_CHANNEL_COUNT                (FLEXIO_SHIFTCTL_COUNT / 2)

/** Number of instances of the FLEXIO module. */
#define FLEXIO_I2C_IP_INSTANCE_COUNT                    (FLEXIO_INSTANCE_COUNT)
