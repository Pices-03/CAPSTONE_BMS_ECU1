...
#if (MEM_43_INFLS_TYPES_VENDOR_ID != FTFC_MEM_INFLS_IP_TYPES_VENDOR_ID)
    #error "Mem_43_INFLSTypes.h and Ftfc_Mem_InFls_Ip_Types.h have different vendor ids"
#endif
/* Check if current file and Ftfc_Mem_InFls_Ip_Types.h header file are of the same Autosar version */
#if ((MEM_43_INFLS_TYPES_AR_RELEASE_MAJOR_VERSION    != FTFC_MEM_INFLS_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (MEM_43_INFLS_TYPES_AR_RELEASE_MINOR_VERSION    != FTFC_MEM_INFLS_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (MEM_43_INFLS_TYPES_AR_RELEASE_REVISION_VERSION != FTFC_MEM_INFLS_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mem_43_INFLSTypes.h and Ftfc_Mem_InFls_Ip_Types.h are different"
#endif
/* Check if current file and Ftfc_Mem_InFls_Ip_Types.h header file are of the same Software version */
#if ((MEM_43_INFLS_TYPES_SW_MAJOR_VERSION != FTFC_MEM_INFLS_IP_TYPES_SW_MAJOR_VERSION) || \
     (MEM_43_INFLS_TYPES_SW_MINOR_VERSION != FTFC_MEM_INFLS_IP_TYPES_SW_MINOR_VERSION) || \
     (MEM_43_INFLS_TYPES_SW_PATCH_VERSION != FTFC_MEM_INFLS_IP_TYPES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mem_43_INFLSTypes.h and Ftfc_Mem_InFls_Ip_Types.h are different"
#endif
