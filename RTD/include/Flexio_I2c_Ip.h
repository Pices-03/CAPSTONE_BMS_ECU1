...
#if (FLEXIO_I2C_IP_VENDOR_ID != FLEXIO_I2C_IP_FEATURES_VENDOR_ID)
    #error "Flexio_I2c_Ip.h and Flexio_I2c_Ip_Features.h have different vendor ids"
#endif
#if (( FLEXIO_I2C_IP_AR_RELEASE_MAJOR_VERSION    != FLEXIO_I2C_IP_FEATURES_AR_RELEASE_MAJOR_VERSION) || \
     ( FLEXIO_I2C_IP_AR_RELEASE_MINOR_VERSION    != FLEXIO_I2C_IP_FEATURES_AR_RELEASE_MINOR_VERSION) || \
     ( FLEXIO_I2C_IP_AR_RELEASE_REVISION_VERSION != FLEXIO_I2C_IP_FEATURES_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Flexio_I2c_Ip.h and Flexio_I2c_Ip_Features.h are different"
#endif
#if (( FLEXIO_I2C_IP_SW_MAJOR_VERSION != FLEXIO_I2C_IP_FEATURES_SW_MAJOR_VERSION) || \
     ( FLEXIO_I2C_IP_SW_MINOR_VERSION != FLEXIO_I2C_IP_FEATURES_SW_MINOR_VERSION) || \
     ( FLEXIO_I2C_IP_SW_PATCH_VERSION != FLEXIO_I2C_IP_FEATURES_SW_PATCH_VERSION))
    #error "Software Version Numbers of Flexio_I2c_Ip.h and Flexio_I2c_Ip_Features.h are different"
#endif
