...
#define LPTMR_GPT_IP_SW_MAJOR_VERSION_C             3
...
void Lptmr_Gpt_Ip_DeInit(uint8 instance)
{
    ...
    Lptmr_Gpt_Ip_u32ChState[instance].chInit = FALSE;
    Lptmr_Gpt_Ip_u32ChState[instance].callback = NULL_PTR;
    Lptmr_Gpt_Ip_u32ChState[instance].callbackParam = 0U;
#endif
}
