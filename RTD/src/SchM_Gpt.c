...
static volatile uint32 msr_GPT_EXCLUSIVE_AREA_15[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_GPT_EXCLUSIVE_AREA_15[NUMBER_OF_CORES];
static volatile uint32 msr_GPT_EXCLUSIVE_AREA_16[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_GPT_EXCLUSIVE_AREA_16[NUMBER_OF_CORES];
...
static volatile uint32 msr_GPT_EXCLUSIVE_AREA_19[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_GPT_EXCLUSIVE_AREA_19[NUMBER_OF_CORES];
...
void SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_15(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    if(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId])
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr = OsIf_Trusted_Call_Return(Gpt_schm_read_msr);
#else
        ...
        msr_GPT_EXCLUSIVE_AREA_15[u32CoreId] = msr;
    }
    reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId]++;
}

void SchM_Exit_Gpt_GPT_EXCLUSIVE_AREA_15(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId]--;
    if ((ISR_ON(msr_GPT_EXCLUSIVE_AREA_15[u32CoreId]))&&(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId]))         /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
        ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_16(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    if(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId])
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr = OsIf_Trusted_Call_Return(Gpt_schm_read_msr);
#else
        ...
        msr_GPT_EXCLUSIVE_AREA_16[u32CoreId] = msr;
    }
    reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId]++;
}

void SchM_Exit_Gpt_GPT_EXCLUSIVE_AREA_16(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId]--;
    if ((ISR_ON(msr_GPT_EXCLUSIVE_AREA_16[u32CoreId]))&&(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId]))         /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
        ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_18(void)
{
    ...
    if(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_18[u32CoreId])
    {
        ...
        msr_GPT_EXCLUSIVE_AREA_18[u32CoreId] = msr;
    }
...
void SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_19(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    if(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId])
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr = OsIf_Trusted_Call_Return(Gpt_schm_read_msr);
#else
        ...
        msr_GPT_EXCLUSIVE_AREA_19[u32CoreId] = msr;
    }
    reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId]++;
}

void SchM_Exit_Gpt_GPT_EXCLUSIVE_AREA_19(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();

    reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId]--;
    if ((ISR_ON(msr_GPT_EXCLUSIVE_AREA_19[u32CoreId]))&&(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId]))         /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
        ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Check_gpt(void)
{
    ...
    EU_ASSERT(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId]);
    reentry_guard_GPT_EXCLUSIVE_AREA_15[u32CoreId] = 0UL; /*reset reentry_guard_GPT_EXCLUSIVE_AREA_15 for the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId]);
    reentry_guard_GPT_EXCLUSIVE_AREA_16[u32CoreId] = 0UL; /*reset reentry_guard_GPT_EXCLUSIVE_AREA_16 for the next test in the suite*/
    ...
    EU_ASSERT(0UL == reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId]);
    reentry_guard_GPT_EXCLUSIVE_AREA_19[u32CoreId] = 0UL; /*reset reentry_guard_GPT_EXCLUSIVE_AREA_19 for the next test in the suite*/
