...
#define LPIT_GPT_IP_SW_MAJOR_VERSION_C             3
...
void Lpit_Gpt_Ip_Deinit(uint8 instance)
{
    ...
    for (channelIndex = 0; channelIndex < LPIT_TMR_COUNT; channelIndex++)
    {
        ...
        Lpit_Gpt_Ip_u32ChState[instance][channelIndex].chInit = FALSE;
        Lpit_Gpt_Ip_u32ChState[instance][channelIndex].callback = NULL_PTR;
        Lpit_Gpt_Ip_u32ChState[instance][channelIndex].callbackParam = 0U;
#endif
    }
...
#if defined(LPIT_0_ISR_USED)
/**
 * @brief   Interrupt handler for LPIT_0 channels.
 * @details Interrupt Service Routine corresponding to LPIT_0 hw module.
 * @param[in]   none
 * @return      void
 * @isr
 * @pre     The driver needs to be initialized
...
ISR(LPIT_0_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(LPIT_0_IP_EXISTS)
    uint8 instance = LPIT_0_IP_INSTANCE_NUMBER;
#else
    #error "undefined LPIT instance number"
#endif
    for (channel = 0U; channel < LPIT_0_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Lpit_Gpt_Ip_GetChannelInterruptFlagStatus(instance, channel);
        if (TRUE == HasChEvOccurred)
        {
            Lpit_Gpt_Ip_ProcessChannelInterrupt(instance, channel);
            EXIT_INTERRUPT();
        }
    }
}
...
/*================================================================================================*/
#if defined(LPIT_0_CH_0_ISR_USED)
/**
 * @brief       Interrupt handler for CH0 channel.
 * @details     Interrupt Service Routine corresponding to LPIT_0 module.
 * @param[in]   none
 * @return  void
 * @isr
 * @pre      The driver needs to be initialized
...
/*================================================================================================*/
#if defined(LPIT_0_CH_1_ISR_USED)
/**
 * @brief       Interrupt handler for CH1 channel.
 * @details     Interrupt Service Routine corresponding to LPIT_0 module.
 * @param[in]   none
 * @return  void
 * @isr
...
/*================================================================================================*/
#if defined(LPIT_0_CH_2_ISR_USED)
/**
 * @brief       Interrupt handler for CH2 channel.
 * @details     Interrupt Service Routine corresponding to LPIT_0 module.
 * @param[in]   none
 * @return  void
 * @isr
...
/*================================================================================================*/
#if defined(LPIT_0_CH_3_ISR_USED)
/**
 * @brief       Interrupt handler for CH3 channel.
 * @details     Interrupt Service Routine corresponding to LPIT_0 module.
 * @param[in]   none
 * @return  void
 * @isr
