...
#define COMPILERDEFINITION_SW_MAJOR_VERSION               3
...
#endif
#if (defined(__GNUC__) && !defined(__DCC__) && !defined(__CC_ARM) && !defined(__ARMCC_VERSION))
         /**
        * @brief Symbol required to be defined when GCC ARM compiler is used.
        */
        #define _GCC_C_S32K1XX_
 #endif      
#ifdef __CC_ARM 
        /**
